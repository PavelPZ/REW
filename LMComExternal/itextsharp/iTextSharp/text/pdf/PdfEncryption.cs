...
/*
 * $Id: PdfEncryption.cs,v 1.4 2009/08/21 12:38:42 pavel Exp $
 *
...
public class PdfEncryption {
    ...
    internal static long seq = DateTime.UtcNow.Ticks + Environment.TickCount;
    ...
    public static byte[] CreateDocumentId() {
        ...
        long time = DateTime.UtcNow.Ticks + Environment.TickCount;
