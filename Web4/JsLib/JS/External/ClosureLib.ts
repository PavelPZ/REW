...
module gCrypt {
   ...
   */
  export function byteArrayToString(arr: number[] | Int8Array): string {
...
module gBase64 {
  ...
  export function LMencodeString(byteArray: number[]| Uint8Array):string {
  ...
  */
  export function encodeByteArray(input: number[] | Int8Array, opt_webSafe: boolean): string {
