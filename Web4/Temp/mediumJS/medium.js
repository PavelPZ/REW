		    ...
		    Medium.Action.prototype = {
              ...
              types;
		        ...
		        utils.addEvent(el, 'paste', this.handledEvents.paste = function (e) {
		          ...
		          //LM START
		          //https://github.com/daviferreira/medium-editor, https://github.com/daviferreira/medium-editor/blob/master/src/js/extensions/paste.js
		          var dataFormat = 'text/plain';
		          if (w.clipboardData && e.clipboardData === undefined) {
		          ...
		          var pastedPlain = event.clipboardData.getData(dataFormat);
		          return medium.paste(pastedPlain);
		          //LM END
