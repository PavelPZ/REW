...
module proxies {
  ...
  export class vyzva57services {
    ...
    static keysFromCompanyTitle(companytitle: string, completed: (res: {  student: {  licId: number;  licCounter: number;  lmcomId: number;  email: string;  firstName: string;  lastName: string;  };  teacher: {  licId: number;  licCounter: number;  lmcomId: number;  email: string;  firstName: string;  lastName: string;  };  admin: {  licId: number;  licCounter: number;  lmcomId: number;  email: string;  firstName: string;  lastName: string;  };  companyTitle: string;  newCompanyId: number;  masterLicId: number;  masterLLicCounter: number;  }) => void): void {
