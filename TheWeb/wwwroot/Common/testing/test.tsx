...
namespace testingTest {
  ...
  export function doRunApp() {
    ...
    <h3>Applications: </h3>
    <a href='#' onClick={ev => flux.doExternalNavigate(router.named.loginTest.index, null, ev) }>Login</a> |
    <a href='#' onClick={ev => flux.doExternalNavigate(router.named.layoutTest.index, null, ev) }>Layout</a> |
    <a href='#' onClick={ev => flux.doExternalNavigate(router.named.validationTest.index, null, ev) }>Validation</a> |
    <a href='#' onClick={ev => flux.doExternalNavigate(router.named.fluxTest.index, null, ev) }>Flux</a>
    <h3>System</h3>
