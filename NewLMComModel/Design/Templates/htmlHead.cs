 ...
 //**************** BOOT
  ...
  if (!string.IsNullOrEmpty(cfg.baseTagUrl)) WriteLine(string.Format("<base href=\"{0}/schools/\" />", cfg.baseTagUrl));
            ...
            this.Write(".js\'></script>\r\n  <![endif]-->\r\n  <!--[if (gte IE 9)]><!-->\r\n  <script type=\'text" +
                    "/javascript\' src=\'../jslib/scripts/jquery2");
            
            #line 23 "d:\LMCom\rew\NewLMComModel\Design\Templates\htmlHead.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(min));
            
            #line default
            #line hidden
            this.Write(".js\'></script>\r\n  <!--<![endif]-->\r\n  <script type=\'text/javascript\' src=\'../jsli" +
                    "b/scripts/underscore");
            
            #line 25 "d:\LMCom\rew\NewLMComModel\Design\Templates\htmlHead.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(min));
            
            #line default
            #line hidden
            this.Write(".js\'></script>\r\n  <script type=\'text/javascript\' src=\'../jslib/js/lmconsoleinit.j" +
                    "s\'></script>\r\n\r\n  <link href=\"../font-awesome/lm/externals");
            
            #line 28 "d:\LMCom\rew\NewLMComModel\Design\Templates\htmlHead.tt"
  ...
  WriteLine(MainPage.writeCss(RewApp.publisherSkinCss(cfg)));
            ...
            #line 36 "d:\LMCom\rew\NewLMComModel\Design\Templates\htmlHead.tt"
  ...
  <!--[if lt IE 7]><script type='text/javascript'>isOk = false; alert('Internet Explorer 7 or better is required!');</script><![endif]-->
